...
const (
	WrapperService_Search_FullMethodName = "/wrapper.WrapperService/Search"
)
...
type WrapperServiceClient interface {
	Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Company, error)
}
...
func (c *wrapperServiceClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*Company, error) {
	out := new(Company)
	err := c.cc.Invoke(ctx, WrapperService_Search_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WrapperServiceServer interface {
	Search(context.Context, *SearchRequest) (*Company, error)
}
...
func (UnimplementedWrapperServiceServer) Search(context.Context, *SearchRequest) (*Company, error) {
...
func _WrapperService_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WrapperServiceServer).Search(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WrapperService_Search_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WrapperServiceServer).Search(ctx, req.(*SearchRequest))
	}
...
var WrapperService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "wrapper.WrapperService",
	HandlerType: (*WrapperServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Search",
			Handler:    _WrapperService_Search_Handler,
		},
	},
